...
<a href="/fall2024/course-files/homework/hw04.zip" class="nu-button">HW4 Starter Code <i class="fas fa-download"></i></a>
...
<img style="width:100%;margin:20px 0px;" src="/fall2024/assets/images/homework/hw04/react-diagram.svg" />
...
<table class="rubric">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <strong>
                    <span class="hw">Extra Credit</span> AddComment.js
                </strong><br>
                Add a Comment
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <strong>
                    <span class="hw">Extra Credit</span> Follow / Unfollow
                </strong>
            </td>
            <td>
                <ul>
        ...
        <tr>
            ...
            <td>
                <strong>
                    <span class="hw">Extra Credit</span> Form Accessibility
                </strong>
